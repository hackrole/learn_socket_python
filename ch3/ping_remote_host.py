...
class Pinger(object):
    ...
    def send_ping(self, sock, ID):
        ...
        header = struct.pack('bbHHH', ICMP_ECHO_REQUEST,
                             0, socket.htons(my_checksum), ID, 1)
        packet = header + data
        socket.sendto(packet, (target_addr, 1))
    ...
    def ping_once(self):
        ...
        try:
            ...
            if errno == 1:
                msg += "ICMP messages can only be sent from user processes"
        ...
        delay = self.receiver_pong(sock, my_ID, self.timeout)
        sock.close()
        return delay
    ...
    def ping(self):
        ...
        for i in xrange(self.count):
            ...
            try:
                ...
                print "Ping failed. (socket error: %s)" % ex[1]
                break
